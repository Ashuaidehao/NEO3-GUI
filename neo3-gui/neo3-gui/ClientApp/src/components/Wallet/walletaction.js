    ...
    <div className="open">
      <Form form={form} onFinish={feedback}>
        <Form.Item
          ...
          rules={[
            { required: true, message: t("wallet.please select file path") },
          ]}
        >
          <Input
            disabled
    ...
    <div className="open">
      <Form form={form} onFinish={veriPrivate}>
        ...
        >
          <Input
            disabled={showElem}
            placeholder={t("please input Hex/WIF private key")}
          />
        </Form.Item>
        {!showElem ? (
          <Form.Item>
    ...
    <div className="open">
      <Form form={form} onFinish={veriPrivate}>
        <Form.Item
          name="private"
          rules={[
            { required: true, message: t("wallet.please input encrypted") },
          ]}
        >
          <Input
            disabled={showElem}
            placeholder={t("wallet.please input encrypted")}
          />
        </Form.Item>
        {!showElem ? (
          <Form.Item
