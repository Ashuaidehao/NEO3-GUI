  ...
  Modal.success({
    ...
    content: (
      <div className="show-pri">
        <p>
          <Trans>blockchain.transaction hash</Trans>：{data.result}
        </p>
      </div>
    ),
...
function error(data) {
  Modal.error({
    ...
    content: (
      <div className="show-pri">
        <p>
          <Trans>blockchain.transaction hash</Trans>: {data.error.code}
        </p>
        <p>
          <Trans>error msg</Trans>: {data.error.message}
        </p>
      </div>
    ),
    okText: <Trans>button.ok</Trans>,
            ...
            <Col span={24} className="bg-white pv4">
              <Tabs className="tran-title" defaultActiveKey="1">
                ...
                <TabPane tab={t("advanced.signature trans")} key="2">
                  <div>
                    <Form name="form" onFinish={this.onSign}>
                    ...
                    <Form name="form" onFinish={this.onBroad} ref="broadform">
