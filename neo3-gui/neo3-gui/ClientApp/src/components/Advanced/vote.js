            ...
            <Col span={24} className="bg-white pv4">
              ...
              <div className="pa3">
                ...
                <Form ref="formRef" onFinish={this.onVote}>
                  ...
                  <h4>
                    {t("advanced.candidate key")}
                    <a
                      className="ml2 small t-green"
                      onClick={this.openUrl("https://neo.org/consensus")}
                    >
                      {" "}
                      {t("advanced.candidate intro")}
                    </a>
                  </h4>
                  <Radio.Group
                  ...
                  >
                    {candidates.map((item, index) => {
                      return (
                        <p key={index}>
                          <Radio value={item.publickey}>{item.publickey}</Radio>{" "}
                          <em className="small"> {item.votes} </em>
                        </p>
                      );
                    })}
                  </Radio.Group>
