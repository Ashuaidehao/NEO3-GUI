        ...
        <Content className="mt3 mb4">
          <Row gutter={[30, 0]} type="flex" style={{ 'minHeight': '120px' }}>
            <Col span={24} className="bg-white pv4">
              ...
              <List
                header={<div><span>{t("blockchain.transaction Info")}</span><span className="float-r ml4"><span className="wa-amount"></span>{t("common.count")}</span><span className="float-r">{t("common.time")}</span></div>}
                footer={<span></span>}
