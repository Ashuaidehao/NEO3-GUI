      ...
      if (_data.msgType === -1) {
        ...
        Modal.success({
          ...
          content: (
            <div className="show-pri">
              <p>
                {t("blockchain.transaction hash")}：{result.txId}
              </p>
            </div>
          ),
          okText: t("button.confirm"),
                      ...
                      <Row>
                        ...
                        <Col span="9">
                          ...
                          >
                            ...
                            >
                              {!!assetlist[field.key]
                                ? assetlist[field.key].map((item) => {
                                    return (
                                      <Option key={item.asset}>
                                        <span className="trans-symbol">
                                          {item.symbol}{" "}
                                        </span>
                          ...
                          <Form.Item
                            ...
                            rules={[
                              ...
                              },
                              {
                                required: true,
                                message: t(
                                  "wallet.please input a correct amount"
                                ),
                              },
                            ]}
                          >
