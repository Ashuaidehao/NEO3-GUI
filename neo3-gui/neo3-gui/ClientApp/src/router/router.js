      ...
      <Route path="/wallet">
        <Layout style={{ height: "calc( 100vh )" }}>
          ...
          <Route
            ...
            component={Authenticated(Walletlist)}
          />
          <Route
            exact
            path="/wallet/walletlist:address"
            component={Authenticated(Walletdetail)}
          />
          <Route
            exact
          ...
          <Route
            ...
            component={Authenticated(Wallettrans)}
          />
          <Route
            exact
            path="/wallet/transaction:hash"
            component={Authenticated(Transdetail)}
          />
          <Route
            exact
            path="/wallet/untransaction:hash"
            component={Authenticated(Untransdetail)}
          />
          <Route
            exact
            path="/wallet/transfer"
            component={Authenticated(Selecttrans)}
          />
        </Layout>
      </Route>
      <Route path="/contract">
        <Layout style={{ height: "calc( 100vh )" }}>
          ...
          <Route
            exact
            path="/contract/detail:hash"
            component={Contractdetail}
          />
          <Route
            exact
            path="/contract/deploy"
            component={Authenticated(Contractdeploy)}
          />
          <Route
            exact
            path="/contract/invoke"
            component={Authenticated(Contractinvoke)}
          />
        </Layout>
      </Route>
      <Route path="/advanced">
        <Layout style={{ height: "calc( 100vh )" }}>
          ...
          <Route
            exact
            path="/advanced/vote"
            component={Authenticated(Advancedvote)}
          />
          <Route
            exact
            path="/advanced/candidate"
            component={Authenticated(Advancedcandidate)}
          />
          <Route
            exact
            path="/advanced/signature"
            component={Authenticated(Advancedsignature)}
          />
        </Layout>
      </Route>
      <Redirect from="*" to="/" />
